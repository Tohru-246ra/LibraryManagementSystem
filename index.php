...
<head>
    ...
    <link rel="stylesheet" href="/LMS/css/index.css">
    ...
    <script src="/LMS/js/make_index.js" defer></script>
...
<body>
    ...
    <main>
        ...
        <div class="book-info">
            <h3 class="book-info-1">新着案内</h3>
            <div id="new-books" class="new-books"></div>

            <h3 class="book-info-2" id="book-info-2" style="display: none;">過去にあなたが登録した書籍</h3>
            <div id="user-books" class="user-books" style="display:none;"></div>
        </div>

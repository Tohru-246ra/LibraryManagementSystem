...
<head>
    ...
    <link rel="stylesheet" href="/LMS/css/register_user.css">
    <script src="/LMS/js/register_user.js" defer></script>
...
<header>
    ...
    <main>
        <div class="main-container">
            <h3>ユーザー登録を行います</h3>
            <form>
                <p class="explanation">あなたの名前を教えてください (必須)</p>
                <input type="text" id="user" class="input">
                <p class="explanation">パスワードを入力してください (必須)</p>
                <input type="password" id="pass1" class="input">
                <p class="explanation" id="last-ex">確認のため、再度パスワードを入力してください (必須)</p>
                <input type="password" id="pass2" class="input">
                <div>                
                    <input type="button" id="register" value="登録" onclick="onclick_btn()">
                </div>
            </form>
        </div>
    </main>

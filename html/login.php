...
<head>
    ...
    <script src="/LMS/js/login.js" defer></script>
...
<body>
    ...
    <main>
        <div class="main-container">
            <h3>ログイン認証を行います</h3>
            <a href="/LMS/html/sign_up.php" class="login-to-user-regi">まだユーザー登録をしていない方はこちらから</a>
            <form>
                <p>ユーザー名</p>
                ...
                <div>                
                    <input type="button" id="login" value="ログイン" onclick="onclick_btn()">
                </div>
            </form>
        </div>
    </main>
